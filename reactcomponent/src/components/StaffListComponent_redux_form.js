...
handleSubmit=(staff)=> {
  ...
  render() {
      ...
      const isdoB=(val)=>(moment(val).format("YYYY-MM-DD") < moment().format("YYYY-MM-DD"));
              ...
              <Modal.Body>
               ...
               />
                    <div className="mb-3">
                        ...
                        <Control className="form-control" model=".doB" type="date"
                            validators={{
                                required,
                                isdoB
                            }}         
                    ...
                    <div className="mb-3">
                        ...
                        <Control className="form-control" model=".startDate" type="date"
                            validators={{
                                required
                            }}                         
                        />
