...
class StaffList extends Component {
  ...
  onBlur = (field) => (e) => {
    ...
    onSubmitForm = (e) => {
      ...
      if (
        JSON.stringify(staff) === JSON.stringify(staffDefault) ||
  ...
  validateForm = () => {
    const { name, doB, salaryScale, startDate, annualLeave, overTime } =this.state;
    ...
    return (
      ...
      <div className="row">
          ...
          <div className="col-lg-2 col-md-2 col-sm-2 col-2 text-center">
            ...
            <Modal show={this.state.isToggle} onHide={this.toggleOnclick} className="w-75 mx-auto">
              <Modal.Header>
